...
}
{
  ...
  ok('22c. catálogo congelado com exatamente os 7 codes esperados', Object.isFrozen(PUBLIC_ERRORS) && Object.keys(PUBLIC_ERRORS).sort().join() === Object.keys(CATALOG).sort().join());
